...
`cloud-itonami-isic-7310` accepts contributions to the OSS blueprint, capability
...
- Keep placing/publishing a campaign on the client's behalf behind the Campaign Governor.
