# Operator Quickstart — Advertising

Shortest path from clone to a verified local dry-run for **ISIC 7310** (`cloud-itonami-isic-7310`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7310.git
cd cloud-itonami-isic-7310
```
...
- Blueprint governor key: `campaign-governor`
- Likely source path: `advertising.governor.cljc`
